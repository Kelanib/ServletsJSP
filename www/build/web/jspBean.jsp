...
<jsp:useBean class="beans.beans01" scope="page" id="beanPage" />
<jsp:useBean class="beans.beans01" scope="request" id="beanRequest" />
<jsp:useBean class="beans.beans01" scope="session" id="beanSession" />
<jsp:useBean class="beans.beans01" scope="application" id="beanApplication" />
